...
mkdir("D:/Programming/Java/Matlab/frontend/src/outputs");
mkdir("D:/Programming/Java/Matlab/frontend/src/outputs/inBack");
mkdir("D:/Programming/Java/Matlab/frontend/src/outputs/inPrime");
...
delete('D:/Programming/Java/Matlab/frontend/src/outputs/inBack/*.png');
delete('D:/Programming/Java/Matlab/frontend/src/outputs/inPrime/*.png');
...
for i = 1:1:18
   ...
   if i<10
        ...
        filename = "D:/Programming/Java/Matlab/frontend/src/outputs/inPrime/" + i+ ".png";
        saveGrafics(dataWithKinPrime(i, :), time, filename, titleString);
   else
       [overshoot, time_n, time_r] = options(dataWithKinBack(i-9, :), time);
       filename = "D:/Programming/Java/Matlab/frontend/src/outputs/inBack/" + (i-9) + ".png";
